...
public class App {
	...
	public static void main(String args[]) {
		...
		/**
		 * Singleton Example Even when we create 2 bean instances of the object
		 * Stage the same instance is returned.
		 **/
		...
		System.out.println("Song writer song name is: " + songWriterAutoWire.getSong().getName() + " lyrics: "
				+ songWriterAutoWire.getSong().getLyrics());
		...
		System.out.println("Singer song name is: "+ singerAutoWireByType.getSong().getName()+ " lyrics: "
		...
		annotationContext = new ClassPathXmlApplicationContext("configuration-wiring.xml");
		Venue venueauto = (Venue) annotationContext.getBean("annotationRequiredExample");
